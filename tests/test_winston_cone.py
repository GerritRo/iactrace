...
def _hex_camera(with_cone):
    ...
    cone = WinstonCone(
        6, entrance_apothem=entrance, exit_apothem=0.35 * entrance,
...
class TestRotationAlignment:
    ...
    def _setup(self):
        ...
        cone = WinstonCone(
            6, entrance_apothem=inrad, exit_apothem=np.sin(np.radians(20.0)) * inrad,
    ...
    def test_orientation_offset_changes_transmission(self):
        ...
        centers0, cone, o0, d0, n = self._setup()
        offset = WinstonCone(
            6, entrance_apothem=cone.entrance_apothem, exit_apothem=cone.exit_apothem,
...
class TestRobustness:
    def test_apply_gradients_are_finite(self):
        ...
        cone = WinstonCone(6, entrance_apothem=0.025, exit_apothem=0.01,
    ...
    def test_small_cone_traces_in_range(self):
        ...
        cone = WinstonCone(6, entrance_apothem=1.25e-4, exit_apothem=5e-5,
