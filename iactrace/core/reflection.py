...
def compute_perturbation_delta(normals, key):
    """
    Compute perturbation delta vectors in tangent space (unit sigma).
    ...
    Returns:
        Delta vectors (..., 3) to be scaled and added to normals
    """
    shape = normals.shape[:-1]
    ...
    return theta1[..., None] * tangent1 + theta2[..., None] * tangent2